...
public class IntergrationTests {
    ...
    public void return_same_input_when_sending_payload() throws IOException, InterruptedException {
        ...
        org.testcontainers.containers.Container.ExecResult result0 = rabbitmq.execInContainer("rabbitmqctl",
                "list_queues");
        System.out.println("***Results 0: " + result0.getStdout());
        ExecResult result2 = rabbitmq.execInContainer("rabbitmqadmin",
                "get queue=identity-in-0.main requeue=false");
        System.out.println("***Results 2: " + result2.getStdout());
        // Assert
